                  ...
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li class="has-children">
                        <a href="category">Who Are You</a>
                        <ul class="dropdown arrow-top">
                          <li><a href="category">Reviewer</a></li>
                          <li><a href="#">Creator</a></li>
                          <li><a href="new-post">Investor</a></li>
                      ...
                      <li><a href="register"><span class="bg-primary text-white py-3 px-4 rounded"><span class="icon-plus mr-3"></span>Register</span></a></li>
                    </ul>
                  </div>
                </nav>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3 mb-3" data-aos="fade-up" data-aos-delay="100">
            <a href="#" class="h-100 feature-item">
              ...
              <h2>Creator</h2>
               <p style="color:#00000">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 </p>
               <!-- <button type="button" class="btn btn-primary">Login</button>
              <button type="button" class="btn btn-danger">Register</button> -->
